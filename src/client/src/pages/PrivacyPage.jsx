  ...
  <div className="min-h-screen bg-[#0f1117]">
    <section className="relative overflow-hidden bg-grid bg-radial-glow">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
        <motion.div {...fadeUp(0)}>
          ...
          <h1 className="text-4xl font-bold text-white mb-3">Privacy <span className="gradient-text">Policy</span></h1>
    ...
    <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-5">
      ...
      <motion.div {...fadeUp(0.4)} className="card p-6">
        ...
        <p className="text-sm text-gray-600">Questions about this policy? Email us at <span className="text-indigo-400">privacy@debugsense.ai</span></p>
      </motion.div>
    </section>
  </div>
);
