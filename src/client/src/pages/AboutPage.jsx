...
const tech = [
  { name: 'React 18', desc: 'Modern UI with hooks and concurrent features', color: 'text-cyan-400' },
  { name: 'Vite', desc: 'Lightning-fast build tool and dev server', color: 'text-yellow-400' },
  { name: 'Tailwind CSS v3', desc: 'Utility-first styling for rapid UI development', color: 'text-sky-400' },
  { name: 'Framer Motion', desc: 'Smooth, production-ready animations', color: 'text-pink-400' },
  { name: 'Node.js + Express', desc: 'Fast, minimal backend API server', color: 'text-green-400' },
  { name: 'MongoDB + Mongoose', desc: 'Flexible document database for history storage', color: 'text-emerald-400' },
  { name: 'Groq API', desc: 'Ultra-fast LLaMA 3.3 70B inference engine', color: 'text-violet-400' },
  { name: 'React Router v7', desc: 'Client-side routing and navigation', color: 'text-orange-400' },
];
...
const AboutPage = () => (
  <div className="min-h-screen bg-[#0f1117]">
    ...
    <section className="relative overflow-hidden bg-grid bg-radial-glow">
      <div className="absolute top-0 left-1/3 w-96 h-64 bg-indigo-600/10 rounded-full blur-3xl pointer-events-none" />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 text-center">
        ...
        <motion.h1 {...fadeUp(0.1)} className="text-5xl sm:text-6xl font-extrabold tracking-tight mb-6">
          Built for <span className="gradient-text">Developers</span>,<br />by Developers
        </motion.h1>
        <motion.p {...fadeUp(0.2)} className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
    ...
    <section className="section-pad bg-[#0d1020]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-6">
          <motion.div {...fadeUp(0)} className="card p-8 hover:border-indigo-500/30 transition-all duration-300">
            <div className="w-10 h-10 bg-indigo-500/10 border border-indigo-500/20 rounded-xl flex items-center justify-center text-indigo-400 mb-5">
          ...
          <motion.div {...fadeUp(0.1)} className="card p-8 hover:border-violet-500/30 transition-all duration-300">
            <div className="w-10 h-10 bg-violet-500/10 border border-violet-500/20 rounded-xl flex items-center justify-center text-violet-400 mb-5">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div {...fadeUp(0)}>
            ...
            <h2 className="text-3xl font-bold text-white mb-5">Why Developers & Students Love It</h2>
            ...
            <ul className="space-y-3">
              {benefits.map((b, i) => (
                <motion.li key={i} {...fadeUp(i * 0.06)} className="flex items-center gap-3 text-sm text-gray-400">
          ...
          <motion.div {...fadeUp(0.15)} className="card p-8 glow-border">
            <h3 className="text-base font-semibold text-white mb-5 flex items-center gap-2">
              <Code2 className="w-4 h-4 text-indigo-400" /> Our Values
            </h3>
            <div className="space-y-5">
              {values.map((v, i) => (
                <div key={i} className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-indigo-500/10 border border-indigo-500/20 rounded-lg flex items-center justify-center text-indigo-400 shrink-0">
                    {v.icon}
                  </div>
                  <div>
    ...
    <section className="section-pad bg-[#0d1020]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div {...fadeUp()} className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold text-white mb-3">Built with Modern Technology</h2>
          <p className="text-gray-500 max-w-xl mx-auto">A carefully chosen stack for performance, reliability, and developer experience.</p>
        </motion.div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {tech.map((t, i) => (
            <motion.div key={i} {...fadeUp(i * 0.05)}
              className="card p-5 hover:border-white/15 hover:-translate-y-1 transition-all duration-300"
            >
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <div className="relative">
            ...
            <h2 className="text-3xl font-bold text-white mb-3">Ready to Debug Smarter?</h2>
            <p className="text-gray-500 mb-7">Join developers worldwide who are fixing errors faster and learning more.</p>
