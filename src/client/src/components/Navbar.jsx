        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <span className="text-lg font-bold gradient-text">DebugSense AI</span>
            </Link>
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={toggleTheme}
                className="p-2 rounded-lg bg-white/5 hover:bg-white/10 text-gray-400 hover:text-gray-100 border border-white/10 transition-all"
              ...
              <button
                ...
                className="md:hidden p-2 rounded-lg bg-white/5 hover:bg-white/10 text-gray-400 border border-white/10 transition-all"
              >
